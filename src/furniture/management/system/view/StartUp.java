...
public class StartUp extends JFrame {
    ...
    public StartUp() {
        label2 = new JLabel("Furniture Matrix");
        label2.setForeground(new Color(15, 50, 61));
        label2.setFont(new Font("Comic Sans MS", Font.BOLD, 37));
        label2.setBounds(386, 76, 430, 60);
        add(label2);

        String longText = "Crafted with care, our furniture tells a story of passion and precision. "
                + "We're not just a furniture brand — we're creators of comfort, "
                + "curators of style, and champions of everyday functionality.";
